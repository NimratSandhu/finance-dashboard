...
from components.charts import create_bar_chart, create_bubble_chart, CHART_TARGET_OPTIONS
...
initial_target = 'MarketCapitalization'
bar_chart_default = initial_target
bubble_chart_x_default = initial_target
bubble_chart_y_default = 'ProfitMargin'
initial_bar_chart = create_bar_chart(overview_df, initial_target)
initial_bubble_chart = create_bubble_chart(overview_df, bubble_chart_x_default, bubble_chart_y_default)
...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(overview_table, id="overview-table-section")
    ]),
    html.Hr(),
    dbc.Row([
        dbc.Col([
            html.H5("Bar Chart"),
            html.Label("Select Metric:", style={'color': '#BDC3C7', 'marginBottom': '0.5rem'}),
            dcc.Dropdown(
        ...
        dbc.Col([
            ...
            html.Label("Select Metrics:", style={'color': '#BDC3C7', 'marginBottom': '0.5rem'}),
            dbc.Row([
                dbc.Col(
                    dcc.Dropdown(
...
def bubble_bar_chart(selected_target_x, selected_target_y):
    bubble_chart = create_bubble_chart(overview_df, selected_target_x, selected_target_y)
    return bubble_chart
